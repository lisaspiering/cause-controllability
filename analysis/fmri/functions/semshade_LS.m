function [lineOut, fillOut] = semshade_LS(amatrix,alpha,acolor,F,smth)
% this function is based on MATLAB's built-in function stdshade which by
% default plots the standard deviation
% however, the appropriate line for computing the standard error of the
% mean is just commented in the stdshade function - so this custom function
% here basically just uncomments the line (l. 36 + 37) to get sem
